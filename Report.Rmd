...
dat[1:8]%>%kable(digits=3)
dat[9:15]%>%kable(digits=3)
...
The result of the LASSO Penalized Logistic model shows that radius, compactness, concavity, and concave points are the most important variables. The result of the RF model suggest that radius, perimeter, area, and concave points are the most important variables. We can conclude that nuclear perimeter and compactness was highly significant in differentiating hyperplasia from carcinoma.
